...
| P-02 | **Set the cloud dollar ceiling** for Phase 1 compute | before Aug 15 | A-004 test decides CPU vs GPU by measured cost; the ceiling bounds total spend. **Proposed for your ratification (2026-08-02): $100 hard ceiling, expected spend $20–60** — headless CPU trials with no renderer (D-007/B′); estimate labeled estimate, arithmetic in the 2026-08-02 session log; exceeding it requires a recorded amendment, not a quiet overrun |
