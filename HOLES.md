...
|---|---|---|---|
| H-17 | **Host pitch/roll are swept axes (IS §9, D-024 attitude envelope, D-029 marginalization) but realized nowhere in the harness** — the sweep_point carries them, the kinematic/contact stages ignore them (recorded in `trial_logger.py`'s docstring since T8; surfaced as a hole at T10, 2026-08-08). D-032 excludes them from Tier-1/Tier-2 rather than emitting fake-flat curves; the D-029 gate's "marginalize over their full committed distributions" is currently a no-op | **CLOSED 2026-08-12 — Door 3 (DECIDED): D-046(b), P-08 sitting.** Host tilt composed ahead of Q_NOMINAL through truth/sightings/handoff/contact; Tier-1 pitch/roll marginals added; the gate marginalizes attitude per trial (freeze_prior_v2) | — |
...
**Open count: 0** (H-17 closed 2026-08-12 via D-046(b), the R01/P-08 sitting; H-18, found and closed 2026-08-09 through D-034/035/036; the gate's sixteen holes and every ratification placeholder
